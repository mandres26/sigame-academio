<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="boletin.aspx.cs" Inherits="PPLWEB.ACADEMIA.reportes.reports.boletin" %>
...
<body>
  ...
  <rsweb:ReportViewer ID="ReportViewer1" runat="server" ZoomMode="FullPage" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="529px" style="text-align: center" Width="867px">
            <LocalReport ReportPath="ACADEMIA\reportes\boletines\primaria\boletin.rdlc">
        ...
        <asp:ObjectDataSource ID="ObjBOLETIN" runat="server" SelectMethod="c_reporteI" TypeName="DAL.RepoReport" OldValuesParameterFormatString="original_{0}">
            <SelectParameters>
