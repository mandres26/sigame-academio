<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="boletin.aspx.cs" Inherits="PPLWEB.ACADEMIA.reportes.reports.boletin_pre" %>
...
<body>
    <form id="form2" runat="server">
      <span>Nota: Por favor espere mientras que el sistema codifica el reporte. Esta operacion puede tardar varios minutos. (Limite de tiempo: 10 min) </span>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" ZoomMode="PageWidth" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="529px" style="text-align: center" Width="867px">
            <LocalReport ReportPath="ACADEMIA\reportes\boletines\preescolar\boletin.rdlc">
        ...
        <asp:ObjectDataSource ID="ObjBOLETIN" runat="server" SelectMethod="c_reporteI" TypeName="DAL.RepoReport">
            <SelectParameters>
