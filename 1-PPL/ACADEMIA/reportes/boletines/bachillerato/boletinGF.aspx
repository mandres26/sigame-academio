<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="boletinGF.aspx.cs" Inherits="PPLWEB.ACADEMIA.reportes.boletines.bachillerato.boletinGF" %>
...
<body>
   ...
   <rsweb:ReportViewer ID="ReportViewer1" runat="server" ZoomMode="FullPage" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="529px" style="text-align: center" Width="867px">
            <LocalReport ReportPath="ACADEMIA\reportes\boletines\bachillerato\boletinGF.rdlc">
