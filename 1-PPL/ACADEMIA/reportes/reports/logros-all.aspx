<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="logros-all.aspx.cs" Inherits="PPLWEB.ACADEMIA.reportes.reports.logros" %>
    ...
    <form id="form2" runat="server">
           <span>Nota: Por favor espere mientras que el sistema codifica el reporte. Esta operacion puede tardar varios minutos. (Limite de tiempo: 10 min) </span>
            ...
            <LocalReport ReportPath="ACADEMIA\reportes\reports_rdlc\logros.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjLogroAll" Name="dsLOGROSS" />
                </DataSources>

            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjLogroAll" runat="server" SelectMethod="c_logros" TypeName="DAL.RepoLogros"></asp:ObjectDataSource>
