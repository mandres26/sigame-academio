<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listadoasistencia.aspx.cs" Inherits="PPLWEB.ACADEMIA.reportes.reports.listadoasistencia" %>
...
<body>
     <form id="form2" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" ZoomMode="FullPage" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="529px" style="text-align: center; margin-top: 0px;" Width="867px">
            <LocalReport ReportPath="ACADEMIA\reportes\reports_rdlc\listadoasistencia.rdlc">
                <DataSources>
